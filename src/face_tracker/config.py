...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            landmark_model_path=Path(os.getenv('FACE_LANDMARK_MODEL_PATH', 'models/face_landmarker.task')),
            calibration_path=Path(os.environ['FACE_CALIBRATION_PATH']) if os.getenv('FACE_CALIBRATION_PATH') else None,
